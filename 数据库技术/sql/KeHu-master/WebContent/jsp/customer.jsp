...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top navbar-inverse" role="navigation"
	...
	<div class="navbar-header">
		<a class="navbar-brand" href="<%=basePath%>customer/list.action">客户管理系统 -Lq版权所有</a>
	</div>
	<!-- 导航栏右侧图标部分 -->
			...
			<ul class="nav nav-pills nav-stacked " id="side-menu" >
				...
				<li role="presentation" class="active" >
				    <a href="${pageContext.request.contextPath }/customer/list.action" >
				      <i class="fa fa-coffee fa-fw"></i> 客户管理
				    </a>
				</li>
    ...
    <!-- 客户列表查询部分  start-->
	<div id="page-wrapper" style="background:#000"  >
			
		 <div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" ><font color="blue">客户管理     <small>关于客户的增删改查</small></font></h1>
			</div>
		</div> 
		<!-- /.row -->
		<div class="panel panel-default" style="background:gray;" class="outdiv">
			...
			<div style="float:right;width:auto;height:64px;" class="indiv">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-primary">
					<div class="panel-heading"><h3 class="panel-title">客户信息列表</h3></div>
					<!-- /.panel-heading -->
					<table class="table table-bordered table-hover" style="background:#B0C4DE">
						<thead>
							<tr>
								<th>编号</th>
								<th>客户名称</th>
						...
						<tbody>
							<c:forEach items="${page.rows}" var="row">
								<tr>
									...
									<td>
										<a href="#" class="btn btn-info  btn-xs" data-toggle="modal" data-target="#customerEditDialog" onclick= "editCustomer(${row.cust_id})">修改用户信息</a>
										<a href="#" class="btn btn-warning btn-xs" onclick="deleteCustomer(${row.cust_id})">删除用户信息</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
