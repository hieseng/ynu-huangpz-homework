...
MySQL - 5.5.27 : Database - boot_crm
*********************************************************************
*/
...
CREATE TABLE `sys_user` (
  ...
  `user_state` int(1) DEFAULT '1' COMMENT '1:正常,0:暂停',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;

/*Data for the table `sys_user` */

insert  into `sys_user`(`user_id`,`user_code`,`user_name`,`user_password`,`user_state`) values (1,'root','root','123',1),(2,'root2','root2','123',1);
